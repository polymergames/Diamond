...
Diamond::UIButton::UIButton(DTransform2 transform,
                            UIFlags flags,
                            tD_pos width,
                            tD_pos height,
...
Diamond::UIView(transform, flags, width, height),
...
Diamond::UIButton::UIButton(const UITouchCallback &onTouchDown,
                            const UITouchCallback &onTouchDrag,
                            const UITouchCallback &onTouchUp) :
UIButton(DTransform2(), NONE, 0, 0, onTouchDown, onTouchDrag, onTouchUp) {}
